...
class GradeBook {
    ...
    Person p1;
    Person p2;
    p1.setPerson("",18,"24csu205",99343468201);
    p1.displayDetails();
    p2.setPerson("Srishti",18,"24csu",8700732768);
    p2.displayDetails();
    cout<<endl;
    Student s1;
    Student s2;
    s1.inputstudent("Srishti",18,"24csu205",9959758201,"12/03/2024","btech",4);
    s1.displayDetails();
    s2.inputstudent("Sri",17,"24csu209",9950600000,"14/03/2025","BBA",5);
    s2.displayDetails();
    cout<<endl;
    Professor pr1;
    Professor pr2;
    pr1.setProfessor("Srishti",35,"24tec45",943583475,"ai/ml","21/03/2024",10000);
    pr1.displayDetails();
    pr2.setProfessor("Siri",32,"24tec75",94465785,"data science","25/03/2025",30000);
    pr2.displayDetails();
    cout<<endl;
    Course c1;
    Course c2;
